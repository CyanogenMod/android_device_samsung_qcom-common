...
public class SamsungDozeSearchIndexablesProvider extends SearchIndexablesProvider {

    private static final int SEARCH_IDX_TOUCHSCREEN_PANEL = 0;

    private static SearchIndexableResource[] INDEXABLE_RES = new SearchIndexableResource[] {
            new SearchIndexableResource(1, R.xml.gesture_panel,
                    SamsungDozeActivity.class.getName(),
